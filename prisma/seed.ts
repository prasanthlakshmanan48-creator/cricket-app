...
async function main() {
  ...
  const playersData = [
    ...
    },
    {
      ...
      isActive: true,
      role: 'Top-order Batter',
      roleTags: 'Batter, Top-order Batter, Captain, Test Specialist',
      battingStyle: 'Right-hand batter',
      bowlingStyle: 'Right-arm leg spin',
      bowlingArm: 'Right',
      wicketkeeper: false,
      ...
      profileImage: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800&auto=format&fit=crop',
      difficultyScore: 1.8,
      popularityRank: 3,
      aliases: ['Smudge', 'Steve Smith', 'SPD Smith'],
      identifiers: [
        { sourceName: 'cricsheet', externalId: 'smith_au_49' },
        { sourceName: 'cricinfo', externalId: '267992' },
      ],
      competitions: ['Test', 'ODI', 'T20I', 'IPL', 'BBL', 'Ashes', 'World Cup'],
      stats: [
        { format: 'TEST', matches: 109, runs: 9685, wickets: 19, battingAvg: 56.97, strikeRate: 53.8, hundreds: 32, fifties: 41, catches: 182 },
        { format: 'ODI', matches: 158, runs: 5446, wickets: 28, battingAvg: 43.91, strikeRate: 87.2, hundreds: 12, fifties: 33, catches: 82 },
      ]
    },
    {
      uuid: 'player-babar-azam-009',
      ...
      debutT20I: '2016',
      careerSpan: '2015-Present',
      profileImage: 'https://images.unsplash.com/photo-1560272564-66952055a498?q=80&w=800&auto=format&fit=crop',
      difficultyScore: 2.1,
      popularityRank: 4,
      aliases: ['Babar', 'Babar Azam', 'Bobby', 'B Azam'],
      identifiers: [
        { sourceName: 'cricsheet', externalId: 'babar_pk_56' },
        { sourceName: 'cricinfo', externalId: '348144' },
      ],
      competitions: ['PSL', 'Test', 'ODI', 'T20I', 'BPL', 'World Cup'],
      stats: [
        { format: 'TEST', matches: 52, runs: 3898, wickets: 2, battingAvg: 45.85, strikeRate: 55.1, hundreds: 9, fifties: 26, catches: 42 },
        { format: 'ODI', matches: 117, runs: 5729, wickets: 0, battingAvg: 56.72, strikeRate: 88.75, hundreds: 19, fifties: 32, catches: 50 },
        { format: 'T20I', matches: 123, runs: 4145, wickets: 0, battingAvg: 41.03, strikeRate: 129.08, hundreds: 3, fifties: 36, catches: 52 },
      ]
    },
    {
      uuid: 'player-smriti-mandhana-010',
      displayName: 'Smriti Mandhana',
      fullName: 'Smriti Shriniwas Mandhana',
      shortName: 'S Mandhana',
      initials: 'SM',
      gender: 'FEMALE',
      ...
      isActive: true,
      role: 'Opening Batter',
      roleTags: 'Batter, Opening Batter, Left-hand Batter',
      ...
      difficultyScore: 3.2,
      popularityRank: 15,
      aliases: ['Smriti Mandhana', 'Mandhana', 'S Mandhana'],
      identifiers: [
        { sourceName: 'cricsheet', externalId: 'mandhana_in_18' },
        { sourceName: 'cricinfo', externalId: '597806' },
      ],
      competitions: ['WPL', 'WBBL', 'The Hundred', 'Test', 'ODI', 'T20I', 'World Cup'],
      stats: [
        { format: 'TEST', matches: 7, runs: 629, wickets: 0, battingAvg: 57.18, strikeRate: 59.8, hundreds: 2, fifties: 3, catches: 4 },
        { format: 'ODI', matches: 85, runs: 3585, wickets: 0, battingAvg: 43.19, strikeRate: 85.3, hundreds: 7, fifties: 27, catches: 27 },
        { format: 'T20I', matches: 136, runs: 3320, wickets: 0, battingAvg: 27.89, strikeRate: 122.5, hundreds: 0, fifties: 24, catches: 31 },
      ]
    },
    {
      uuid: 'player-bas-de-leede-011',
      displayName: 'Bas de Leede',
      fullName: 'Bastianus Franciscus Wilhelmus de Leede',
      shortName: 'B de Leede',
      initials: 'BL',
      gender: 'MALE',
      ...
      isActive: true,
      role: 'Batting All-rounder',
      roleTags: 'All-rounder, Batting All-rounder, Fast-medium Bowler',
      battingStyle: 'Right-hand batter',
      ...
      difficultyScore: 7.8,
      popularityRank: 92,
      aliases: ['Bas de Leede', 'de Leede'],
      identifiers: [
        { sourceName: 'cricsheet', externalId: 'deleede_nl_59' },
        { sourceName: 'cricinfo', externalId: '922943' },
      ],
      competitions: ['ODI', 'T20I', 'World Cup', 'IL T20'],
      stats: [
        { format: 'ODI', matches: 38, runs: 925, wickets: 32, battingAvg: 27.2, strikeRate: 78.4, hundreds: 1, fifties: 3, catches: 15 },
        { format: 'T20I', matches: 35, runs: 690, wickets: 30, battingAvg: 25.5, strikeRate: 114.2, hundreds: 0, fifties: 2, catches: 11 },
      ]
    },
    {
  ...
  for (const p of playersData) {
    ...
    if (stats && stats.length > 0) {
      await prisma.playerStatistic.createMany({
        data: stats.map((st: SeedStat) => ({
          ...
          bowlingAvg: st.bowlingAvg,
          economy: st.economy,
          hundreds: st.hundreds ?? 0,
          fifties: st.fifties ?? 0,
          fiveWickets: st.fiveWickets ?? 0,
          catches: st.catches ?? 0,
          stumpings: st.stumpings ?? 0,
        })),
      });
    }
    ...
    await prisma.imageAsset.create({
      data: {
        playerId: createdPlayer.id,
        url: createdPlayer.profileImage,
        type: 'PRIMARY',
        license: 'PUBLIC_DOMAIN',
        source: 'Unsplash Editorial Sports',
        approvalStatus: 'APPROVED',
      },
    });
  }

  // Create Today's Daily Challenge (Date: 2026-09-05)
  ...
  console.log(`✅ Seeded ${playersData.length} players and today's daily challenge!`);
}
